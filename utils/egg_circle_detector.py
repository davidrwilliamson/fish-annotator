...
def main():
    folders = ['20200412/2', '20200412/DCA-ctrl-2', '20200412/DCA-0,15', '20200412/DCA-0,31', '20200412/DCA-0,62', '20200412/DCA-1,25', '20200412/DCA-2,50', '20200412/DCA-5,00']
               #  ['20200404/3', '20200405/1', '20200406/1', '20200407/1',
    ...
    cf = open(circle_file, 'a')

    for ff in folders:
        print('Folder: {}'.format(ff))
        folder = os.path.join('/media/dave/SINTEF Polar Night D/Easter cod experiments/Bernard/', ff, 'png_exports/full')
